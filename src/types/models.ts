...
export type CreateScriptInput = Pick<Script, 'title' | 'description'> & 
  Partial<Pick<Script, 'logline' | 'genre' | 'author' | 'tags'>>
...
export type UpdateCharacterInput = Partial<Omit<Character, 'id' | 'createdAt' | 'scriptId'>>

export type CreateLocationInput = Pick<Location, 'scriptId' | 'name' | 'type'> &
  Partial<Omit<Location, 'id' | 'createdAt' | 'updatedAt'>>

export type UpdateLocationInput = Partial<Omit<Location, 'id' | 'createdAt' | 'scriptId'>>

export type CreateNoteInput = Pick<Note, 'scriptId' | 'text'> &
  Partial<Omit<Note, 'id' | 'createdAt' | 'updatedAt'>>

export type UpdateNoteInput = Partial<Omit<Note, 'id' | 'createdAt' | 'scriptId'>>